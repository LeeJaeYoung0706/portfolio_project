export const initProjectList: ProjectInterface[] = [
  ...
  },
  {
    ...
    review: "\n" +
      ...
      "학점계산기\n" +
      "온라인 도장\n" +
      "맞춤법 검사 오탈자에서 문법까지 확실히 점검하여 완벽한 자기소개서를 만드세요.\n" +
      "총 155자 500자\n" +
      "Styled-Components와 css3을 사용하고 라이브러리를 최대한 지양하면서 레이아웃작업부터 끝까지 해보고 싶었습니다. 회사에서는 어느 정도 틀이 나온 상태로 작업을 했었기 때문에 경험해보고 싶었고 기초를 다시 한번 되돌아보고 많은 것들을 알 수 있는 프로젝트였습니다."
  },
]